...
初始生命值由角色决定，随着等级提升而增长。生命值不会自动恢复，可通过食物与药水来恢复，生命值可通过天赋与词条来额外提高。

## 能量

初始能量由角色决定，一般为 **100** 能量，部分角色则为 **125** 能量。能量会随着时间缓慢恢复，击杀怪物会恢复 **5%** 能量。当前能量显示在原版经验条上，经验条的等级就是能量的具体数值，能量可通过词条来额外提高。

## 护盾

护盾是通过技能形成的短暂的额外生命值，用来抵消伤害，在关键时刻能起到保命作用。但护盾值有上限，初始为角色最大生命值的 **50**%，可通过词条来提高。并且护盾在脱离战斗后会持续衰减直至为 0。
...
角色每次升一级就能获得 **4** 天赋点，玩家可以自由分配加点来决定角色的发展偏向，钻研出最适合自己玩法的搭配。
